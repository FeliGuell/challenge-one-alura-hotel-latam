...
public class Login extends JFrame {
	...
	private void Login() {
		var loginList = this.loginController.listar();

		String contrase = new String(txtContrasena.getPassword());

		Optional<LoginModel> optionalLogin = loginList.stream()
				.filter(x -> x.getUser().equals(txtUsuario.getText()) && x.getPassword().equals(contrase))
				.findFirst();
